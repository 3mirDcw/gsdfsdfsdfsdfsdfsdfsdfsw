...
module.exports = client => {
  ...
  client.user.setActivity(`🚀 !yardım | ShowTeam`, { type: "LISTENING"});
  console.log(`BOT: Şu an ` + client.channels.size + ` adet kanala, ` + client.guilds.size + ` adet sunucuya hizmet veriliyor!`);
};