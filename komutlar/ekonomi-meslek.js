...
let s = message.guild.id
  ...
  let elmas = await db.fetch(`elmascıklar_${message.author.id+s}`);
  let altın = await db.fetch(`altıncıklar_${message.author.id+s}`);
  let para = await db.fetch(`paracık_${message.author.id+s}`);

  let meslek = await db.fetch(`meslek_${message.author.id+s}`);
  let meslekA = await db.fetch(`meslekA_${message.author.id+s}`);
...
message.channel.send(e2)
    ...
    .setColor('RED')
     ...
     db.add(`meslek_${message.author.id+s}`, 300)
     db.add(`paracık_${message.author.id+s}`, -1000)
     db.set(`meslekA_${message.author.id+s}`, madenciA)
    ...
    if (x === 'çiftçi') {
      db.add(`meslek_${message.author.id+s}`, 1)
      ...
      message.channel.send(`${client.emojis.get(client.emojiler.hayır)} Çiftçi olmak için yeterli paran bulunuyor. \n Gerekli olan para: **2000TL**.`)
        ...
        .setTimestamp()
       message.channel.send(madenciE)
       db.delete(`meslekA_${message.author.id+s}`)
       db.add(`meslek_${message.author.id+s}`, 200)
       db.add(`paracık_${message.author.id+s}`, -2000)
       db.set(`meslekA_${message.author.id+s}`, çiftçiA)
       db.add(`meslek_${message.author.id+s}`, -1)
    ...
    if (x === 'tamirci') {
      ...
      message.channel.send(`${client.emojis.get(client.emojiler.hayır)} tamirci olmak için yeterli paran bulunuyor. \n Gerekli olan para: **3000TL**.`)
       ...
       db.delete(`meslekA_${message.author.id+s}`)
       db.add(`meslek_${message.author.id+s}`, 200)
       db.add(`paracık_${message.author.id+s}`, -3000)
       db.set(`meslekA_${message.author.id+s}`, tamirciA)
       db.add(`meslek_${message.author.id+s}`, -1)
    ...
    if (x === 'emlakçı') {
      ...
      message.channel.send(`${client.emojis.get(client.emojiler.hayır)} emlakçı olmak için yeterli paran bulunuyor. \n Gerekli olan para: **5000TL**.`)
       ...
       db.delete(`meslekA_${message.author.id+s}`)
       db.add(`meslek_${message.author.id+s}`, 200)
       db.add(`paracık_${message.author.id+s}`, -5000)
       db.set(`meslekA_${message.author.id+s}`, emlakçıA)
       db.add(`meslek_${message.author.id+s}`, -1)
    ...
    if (x === 'mimar') {
      ...
      message.channel.send(`${client.emojis.get(client.emojiler.hayır)} mimar olmak için yeterli paran bulunuyor. \n Gerekli olan para: **10000TL**.`)
       ...
       db.delete(`meslekA_${message.author.id+s}`)
       db.add(`meslek_${message.author.id+s}`, 300)
       db.add(`paracık_${message.author.id+s}`, -10000)
       db.set(`meslekA_${message.author.id+s}`, mimarA)
       db.add(`meslek_${message.author.id+s}`, -1)
    ...
    if (x === 'doktor') {
      ...
      message.channel.send(`${client.emojis.get(client.emojiler.hayır)} doktor olmak için yeterli paran bulunuyor. \n Gerekli olan para: **20000TL**.`)
       ...
       db.delete(`meslekA_${message.author.id+s}`)
       db.add(`meslek_${message.author.id+s}`, 300)
       db.add(`paracık_${message.author.id+s}`, -20000)
       db.set(`meslekA_${message.author.id+s}`, doktorA)
       db.add(`meslek_${message.author.id+s}`, -1)
